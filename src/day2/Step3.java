...
public class Step3 {//class s
    ...
    public static void main(String[] args) {//main s
        ...
        System.out.println(!(x >=20)); //flase => !false=> true

        //5. 복합대입연산자
            //= 대입연산자 : 오른쪽 값을 왼쪽에 대입 한다
        int z = 30;
            //+= -= *= /= %= : 오른쪽 값을 왼쪽에 연산후 결과를 왼쪽에 대입
        z += 1;
        z= z+1;
