...
public class Customer {
    //멤버변수: 객체내 속성을 저장할 변수,접근제한자 static 타입 변수명
        //private:다른클래스로부터 접근제한, 현재 클래스에서만 호출이 가능하다.
        //-public: 다른 클래스로부터 접근가능, 현재 외 다른 클래스에서도 호출이 가능하다.
        //정적변수
        //static :메소드 영역에 저장되는 변수로써 객체가 없어도 사용이 가능하다. -
    ...
    //2.생성자: 객체 생성(new) 시 사용되는 메소드, 반환타입이 없다.
        ...
        //-생성자가 한 개 이상 존재하면 기본생성자는 자동으로 생성되지 않는다.
    ...
    public  int calcPirce(int price){
        ...
        return price; //반환값, 값은 메소드 타입과 일치한 값, 반환값이 없으면 void 타입
    }
