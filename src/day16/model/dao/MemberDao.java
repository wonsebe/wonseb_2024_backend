...
public class MemberDao {
    ...
    //1. 회원가입 화면 함수
    public boolean signup(MemberDto memberDto){//signup 공개(public)로 하여 boolean 값을 반환한다는 메소드 정의
    try {
        //SQL 작성
    ...
    public  int login(MemberDto memberDto){  //login 공개(public)로 하여 int로 값을 반환한다는 메소드 정의
    //1.SQL 작성
        try {
    ...
    //3.아이디 찾기 화면 함수
    public  String findId(MemberDto memberDto){ //findId 공개(public)로 하여 String로 값을 반환한다는 메소드 정의
        try {
